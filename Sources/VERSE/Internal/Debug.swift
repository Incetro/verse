...
func debugDiff<T>(
    _ before: T,
    _ after: T,
    printer: (T) -> String = { debugOutput($0) }
) -> String? {
...
// MARK: - Date + CustomDebugOutputConvertible
...
// MARK: - URL + CustomDebugOutputConvertible
...
// MARK: - SFSpeechRecognizerAuthorizationStatus + CustomDebugOutputConvertible
