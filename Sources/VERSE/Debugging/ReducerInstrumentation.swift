...
extension Reducer {
    ...
    public func signpost(
        _ prefix: String = "",
        log: OSLog = OSLog(
            subsystem: "com.incetro.verse",
            category: "ReducerInstrumentation"
        )
    ) -> Self {
        ...
        return Self { state, action, environment in
            ...
            if log.signpostsEnabled {
                ...
                os_signpost(.begin, log: log, name: "Action", "%s%s", prefix, actionOutput.unsafelyUnwrapped)
            }
            ...
            if log.signpostsEnabled {
                ...
                return
                    effects
                    .effectSignpost(prefix, log: log, actionOutput: actionOutput.unsafelyUnwrapped)
                    .eraseToEffect()
            }
            return effects
        }
