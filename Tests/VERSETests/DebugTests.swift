...
final class DebugTests: XCTestCase {
    ...
    func testDictionary() {
        XCTAssertEqual(
            debugOutput(["Fame": 1, "Fame Jr.": 2, "Fame Sr.": 3]),
            """
      [
        "Fame Jr.": 2,
        "Fame Sr.": 3,
      ...
      """
        ...
        XCTAssertEqual(
            debugOutput([1: ["Fame": 1], 2: ["Fame Jr.": 2], 3: ["Fame Sr.": 3]]),
            """
      [
        1: [
          "Fame": 1,
    ...
    func testEnum() {
      ...
      """
        ...
        XCTAssertEqual(
            debugOutput(Enum.caseWithTwoLabeledAssociatedValues(one: 1, two: "Fame")),
            """
      ...
      """
        ...
        //    XCTAssertEqual(
        //      debugOutput(Enum.caseWithTuple((one: 1, two: "Fame"))),
        //      """
        //      Enum.caseWithTuple(
        //        (
        //          one: 1,
    ...
    func testDebugOutputConvertible() {
        ...
        XCTAssertEqual(
            debugOutput(URL(string: "https://www.apple.com")!),
            "https://www.apple.com"
        )
    }
    ...
    func testDebugCaseOutput() {
        ...
        XCTAssertEqual(
            debugCaseOutput(Action.action1(true, label: "Fame")),
            "Action.action1(_:, label:)"
        )

        XCTAssertEqual(
            debugCaseOutput(Action.action2(true, 1, "Fame")),
    ...
    func testDebugOutput() {
        ...
        XCTAssertEqual(
            debugOutput(Action.action1(true, label: "Fame")),
            """
      Action.action1(
        true,
        label: "Fame"
      ...
      """
        ...
        XCTAssertEqual(
            debugOutput(Action.action2(true, 1, "Fame")),
            """
      Action.action2(
        true,
        1,
